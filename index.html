              ...
              <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel"><!--Начало блока карусель-->
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="4000">
                    <img src="imgs/pictures/picture_EBFI_history.jpg" class="d-block w-100" alt="HISTORY">
                  ...
                  <div class="carousel-item" data-bs-interval="4000">
                    <img src="imgs/pictures/picture_Expiriance.jpg" class="d-block w-100" alt="EXPERIANCE">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>EXPERIANCE</h5>
                      </div>
                  </div>
                  <div class="carousel-item" data-bs-interval="4000">
                    <img src="imgs/pictures/picture_Inspection_ports.jpg" class="d-block w-100" alt="PRESHIPMENT INSPECTION / QUANTITY / CONDITION">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>PRESHIPMENT INSPECTION / QUANTITY / CONDITION</h5>
                      </div>
                  </div>
                  <div class="carousel-item" data-bs-interval="4000">
                    <img src="imgs/pictures/picture_Quality_inspection.jpeg" class="d-block w-100" alt="QUALITY INSPECTION">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>QUALITY INSPECTION</h5>
                      </div>
                  </div>
                  <div class="carousel-item" data-bs-interval="4000">
                    <img src="imgs/pictures/picture_Expidating.jpg" class="d-block w-100" alt="EXPIDATING">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>EXPIDATING</h5>
                      </div>
                  </div>
                  <div class="carousel-item" data-bs-interval="4000">
                    <img src="imgs/pictures/picture_Aadits.jpg" class="d-block w-100" alt="AUDITS">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>AUDITS</h5>
                      </div>
                  </div>
                  <div class="carousel-item" data-bs-interval="4000">
                    <img src="imgs/pictures/picture_Map.png" class="d-block w-100" alt="COUNTRY">
                    <div class="carousel-caption d-none d-md-block">
                      <a href="map.html">  
                      <h5>COUNTRY</h5>
                    </a>
                  ...
                  <div class="carousel-item" data-bs-interval="4000">
                    <img src="imgs/pictures/picture_Expiriance.jpg" class="d-block w-100" alt="LABORATORIES">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>LABORATORIES</h5>
                      </div>
                  </div>
                  ...
                  <div class="carousel-item" data-bs-interval="4000">
                    <img src="imgs/pictures/picture_Expiriance.jpg" class="d-block w-100" alt="OUR ATTESTATION / SERTIFICATION">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>OUR ATTESTATION / SERTIFICATION</h5>
                      </div>
                  </div>
                </div>
